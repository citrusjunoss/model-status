...
final class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        offerApplicationMigrationIfNeeded()
    ...
    private func offerApplicationMigrationIfNeeded() {
        guard !isQAPreview,
        ...
        do {
            try beginApplicationMigration(from: currentAppURL, to: destinationFolder)
        } catch {
    ...
    private func beginApplicationMigration(from sourceAppURL: URL, to destinationFolder: URL) throws {
        let fileManager = FileManager.default
        ...
        do {
            ...
            guard let copiedBundle = Bundle(url: stagingAppURL),
                  ...
                  runTool("/usr/bin/codesign", arguments: ["--verify", "--deep", "--strict", stagingAppURL.path]) else {
                throw NSError(
...
private func formatGaugeLatency(_ milliseconds: Int) -> String {
...
enum ModelStatusMain {
    ...
    static func main() {
        if !ProcessInfo.processInfo.arguments.contains(AppConfig.migrationRelaunchArgument) {
